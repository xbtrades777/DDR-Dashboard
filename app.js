  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="mt-6">
        ...
        {probabilityStats && probabilityStats.firstHitStats && probabilityStats.secondHitStats && (
          <>
            {/* First Hit Timing */}
            <div className="mb-6 p-4 bg-blue-50 rounded-lg">
              <h3 className="font-medium text-gray-700 mb-2">First Hit Timing</h3>
              <p><strong>Median Time:</strong> {probabilityStats.firstHitStats.median}</p>
              <p><strong>70th Percentile:</strong> {probabilityStats.firstHitStats.percentile70}</p>
              <div className="mt-4 h-64">
                <canvas id="firstHitChart" className="w-full h-full"></canvas>
              </div>
            </div>

            {/* Second Hit Timing */}
            <div className="mb-6 p-4 bg-green-50 rounded-lg">
              <h3 className="font-medium text-gray-700 mb-2">Second Hit Timing</h3>
              <p><strong>Median Time:</strong> {probabilityStats.secondHitStats.median}</p>
              <p><strong>70th Percentile:</strong> {probabilityStats.secondHitStats.percentile70}</p>
              <div className="mt-4 h-64">
                <canvas id="secondHitChart" className="w-full h-full"></canvas>
              </div>
            </div>
          </>
        )}
